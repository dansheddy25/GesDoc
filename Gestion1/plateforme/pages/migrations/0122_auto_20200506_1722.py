# Generated by Django 3.0.3 on 2020-05-06 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_who', models.CharField(default='', max_length=100)),
                ('sujet_msg', models.CharField(default='', max_length=100)),
                ('msg', models.TextField(default='')),
                ('date', models.DateTimeField(default=datetime.datetime.now)),
                ('sender', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='pages.Individu')),
            ],
        ),
    ]
